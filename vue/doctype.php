...
<head>
	...
	<!-- IE Apps -->
		...
		<!-- taches -->
			<meta name="msapplication-task" content="name=Object list; action-uri=<?php echo PREFIX_LINK_LANG; ?>; icon-uri=<?php echo PREFIX_ABSOLUTE_LINK; ?>favicon.ico">
			<?php
				if( $this->name == 'object' ) {
			...
			?>
			<meta name="msapplication-task" content="name=Tag list; action-uri=<?php echo PREFIX_LINK_LANG; ?>tags/; icon-uri=<?php echo PREFIX_ABSOLUTE_LINK; ?>favicon.ico">
			<?php
				if( $this->name == 'tag' ) {
			...
			?>
			<meta name="msapplication-task" content="name=About; action-uri=<?php echo PREFIX_ABSOLUTE_LINK; ?>about/; icon-uri=<?php echo PREFIX_ABSOLUTE_LINK; ?>favicon.ico">
			<meta name="msapplication-task" content="name=Admin space; action-uri=<?php echo PREFIX_ABSOLUTE_LINK; ?>admin/; icon-uri=<?php echo PREFIX_ABSOLUTE_LINK; ?>favicon.ico">
		<!-- /taches -->
	<!-- / IE Apps -->

<!DOCTYPE HTML><html lang="fr"><head><meta charset="UTF-8"><meta name="Generator" content="OpenLibrerian"><meta name="robots" content="<?php echo $robotsInstruction ?>"><meta name="author" content="<?php echo PREFIX_ABSOLUTE_LINK; ?>humans.txt"><meta name="designer" content="Ajabep"><meta name="owner" content="Ajabep"><?php if($this->name=='index'){ echo '<meta name="identifier-URL" content="'.PREFIX_ABSOLUTE_LINK.'">';} ?><meta name="coverage" content="Worldwide"><meta name="distribution" content="Global"><meta name="rating" content="General"><title><?php
	if( $this->name == 'index' ) {
...
?>OpenLibrerian</title><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="HandheldFriendly" content="true"><meta name="MobileOptimized" content="width"><!--[if IE]><meta http-equiv="X-UA-Compatible" content="IE=edge" /><![endif]--><!--[if IE]><meta http-equiv="X-UA-Compatible" content="IE=10"><![endif]--><!--[if lt IE 9]><script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><![endif]--><meta name="msapplication-config" content="/IEconfig.xml" /><meta name="msapplication-navbutton-color" content="#fff"><meta name="msapplication-TileColor" content="#fff"><meta name="msapplication-TileImage" content="<?php echo PREFIX_ABSOLUTE_CDN; ?>img/mstile-144x144.1.png"><meta name="msapplication-square70x70logo" content="<?php echo PREFIX_ABSOLUTE_CDN; ?>img/mstile-70x70.1.png"><meta name="msapplication-square150x150logo" content="<?php echo PREFIX_ABSOLUTE_CDN; ?>img/mstile-150x150.1.png"><meta name="msapplication-square310x310logo" content="<?php echo PREFIX_ABSOLUTE_CDN; ?>img/mstile-310x310.1.png"><meta name="msapplication-square310x150logo" content="<?php echo PREFIX_ABSOLUTE_CDN; ?>img/mstile-310x150.1.png"><meta name="msapplication-task" content="name=Liste d'objets; action-uri=<?php echo PREFIX_LINK_LANG; ?>; icon-uri=<?php echo PREFIX_ABSOLUTE_LINK; ?>favicon.ico"><?php
	if( $this->name == 'object' ) {
...
?><meta name="msapplication-task" content="name=Liste de mots-clés; action-uri=<?php echo PREFIX_LINK_LANG; ?>tags/; icon-uri=<?php echo PREFIX_ABSOLUTE_LINK; ?>favicon.ico"><?php
	if( $this->name == 'tag' ) {

		...
		<p class="alert alert-danger">ERREUR: <?php
		...
		?> Vous avez essayé de demander la réinitialisation de votre mot de passe. Cette demande a échouée. Maintenant, que voulez vous faire ?</p>
		
		<div class="panel-group" id="solutions">
			<div class="panel panel-success">
				<div class="panel-heading">
					<h2 class="panel-title"><a data-toggle="collapse" data-parent="#solutions" href="#tryAgain">Réessayer de vous connecter</a></h2>
				</div>
				<div id="tryAgain" class="panel-collapse collapse">
					<div class="panel-body">
						<p>Pour ressayer de vous connecter, rechargez la page <a href="<?php echo PREFIX_LINK_LANG; ?>admin/">en cliquant sur ce lien</a>.</p>
					</div>
				</div>
			</div>
			<div class="panel panel-danger">
				<div class="panel-heading">
					<h2 class="panel-title"><a data-toggle="collapse" data-parent="#solutions" href="#reset">Réessayer de re-initialiser votre mot-de-passe</a></h2>
				</div>

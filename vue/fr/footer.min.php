</main><footer><div class="container"><p class="pull-right"><a href="#top">Revenir en haut</a></p><p>Fièrement propulsé par <a href="https://github.com/ajabep/OpenLibrerian/">OpenLibrerian</a>, créé avec <span class="heartIcon" title="amour">&lt;3</span> par <a href="http://ajabep.tk">Ajabep</a>.</p></div></footer><script src="<?php echo PREFIX_ABSOLUTE_CDN; ?>js/jquery-1_11_1.1.min.js"></script><script src="<?php echo PREFIX_ABSOLUTE_CDN; ?>js/bootstrap.1.min.js"></script><?php

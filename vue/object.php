		...
		<p class="text-center"><a href="<?php echo PREFIX_LINK_LANG; ?>download/<?php echo $object->ID(); ?>/<?php echo urlencode($object->name()); ?>" class="btn btn-lg btn-primary">Download <span class="glyphicon glyphicon-download"></span></a></p>
							...
							<div class="modal-body">
								<form action="#">
									<div class="form-group">
										<input type="text" class="form-control" id="addTagInput" placeholder="Tag name" title="Tag name" list="tagsList" autocomplete="off">
									</div>
								</form>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
								<button type="button" class="btn btn-primary" id="btnAddTag">Save changes</button>
							</div>
						</div><!-- /.modal-content -->
					</div><!-- /.modal-dialog -->
				</div><!-- /.modal -->

		...
		<p class="alert alert-danger">ERROR : <?php
		...
		?> You have try to ask for reset the password. But you have failed. Now, what do you want to do ?</p>
		
		<div class="panel-group" id="solutions">
			<div class="panel panel-success">
				<div class="panel-heading">
					<h2 class="panel-title"><a data-toggle="collapse" data-parent="#solutions" href="#tryAgain">Try again to log in</a></h2>
				</div>
				<div id="tryAgain" class="panel-collapse collapse">
					<div class="panel-body">
						<p>To try again  to fill the log in form, reload this page, <a href="<?php echo PREFIX_LINK_LANG; ?>admin/">click here</a></p>
					</div>
				</div>
			</div>
			<div class="panel panel-danger">
				<div class="panel-heading">
					<h2 class="panel-title"><a data-toggle="collapse" data-parent="#solutions" href="#reset">Try again to reset password</a></h2>
				</div>

		...
		<?php
			if($send) {
				echo '<p class="alert alert-success">You have begin the three steps to reset your password. To verifing your identity, we have send you a mail.</p>
				...
				<div class="panel panel-default">
					...
					<ul class="list-group">
						...
						<li class="list-group-item list-group-item-info">2. We have send you an mail. Click on the link in this mail.</li>
						<li class="list-group-item">3. Define your new password.</li>
					</ul>
				</div>';
			}
			else {

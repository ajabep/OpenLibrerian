		...
		<div class="alert alert-warning">
			<p>You will delete the tag named "<?php echo $tag->name(); ?>". If you delete it, you will be unable recover it.<br>Are you sure to delete it ?</p>
			<div class="text-right">
				<a href="<?php echo PREFIX_LINK_LANG; ?>tag/<?php echo $tag->ID(); ?>/<?php echo stringToUrl($tag->name()); ?>/" class="btn btn-default" data-dismiss="modal">Cancel</a>
